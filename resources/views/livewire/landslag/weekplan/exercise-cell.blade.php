<div>
    ...
    <td class="{{$this->isToday()}} text-center py-2 px-2 border-t dark:border-gray-600 border-gray-500 {{ $exercise !== null && isset($exercise['intensity']) ? getIntensityColorClass($exercise['intensity']) : '' }}"
        style="{{$borderR}}"
