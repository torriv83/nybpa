...
class StatsOverview extends BaseWidget
{
    ...
    protected function getCards(): array
    {
        ...
        $economy = Cache::remember('economy', now()->addYear(), function () {
        ...
        return [
            Card::make('I året før skatt', number_format($sumBeforeTax, 0, ',', ' '))
                ->description(number_format($sumBeforeTax / 12, 0, ',', ' ') . ' i måneden'),
            Card::make('I året etter skatt', number_format($sumAfterTax, 0, ',', ' '))
