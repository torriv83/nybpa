    ...
    public function up()
    {
        ...
        Schema::create($tableNames['model_has_permissions'], function (Blueprint $table) use ($tableNames, $columnNames, $teams)
        {
            ...
            if ($teams)
            {
                ...
                $table->primary([
                    $columnNames['team_foreign_key'], app(PermissionRegistrar::class)->pivotPermission, $columnNames['model_morph_key'], 'model_type'
                ],
        ...
        Schema::create($tableNames['model_has_roles'], function (Blueprint $table) use ($tableNames, $columnNames, $teams)
        {
            ...
            if ($teams)
            {
                ...
                $table->primary([
                    $columnNames['team_foreign_key'], app(PermissionRegistrar::class)->pivotRole, $columnNames['model_morph_key'], 'model_type'
                ],
        ...
        Schema::create($tableNames['role_has_permissions'], function (Blueprint $table) use ($tableNames)
        {
            ...
            $table->primary([app(PermissionRegistrar::class)->pivotPermission, app(PermissionRegistrar::class)->pivotRole],
